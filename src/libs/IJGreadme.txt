...
plus two main applications "cjpeg" and "djpeg", which use the library to
...
omits the main images that appeared in CACM, but it includes corrections
...
about data compression in general.  The book's JPEG main code is far from
